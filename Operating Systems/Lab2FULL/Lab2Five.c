/* Name: Nicholas Freeman 
   ...
   Description: This program creates seven processes and gives the ID of each individual process as well as its
   parent ID.
*/
#include <pthread.h>
...
int main(int argc, char *argv[]) {
    ...
    if (pid1){//If in main create another child process
		...
		if(pid3){//if in pid2, create second grandchild process
	...
	if (pid5){//if in pid1, create second grandchild
